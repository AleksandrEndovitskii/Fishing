...
namespace Managers
{
    ...
    internal class MyCustomData : INetworkSerializable, IEquatable<MyCustomData>
    {
        ...
        public bool Equals(MyCustomData other)
        {
            if (other is null)
            {
                return false;
            ...
            return IntVariable == other.IntVariable && BoolVariable == other.BoolVariable && StringVariable == other.StringVariable;
        }
        public override bool Equals(object obj)
        {
            ...
            return Equals((MyCustomData)obj);
        }
        public override int GetHashCode()
        {
            return HashCode.Combine(IntVariable, BoolVariable, StringVariable);
        }
    }
}
